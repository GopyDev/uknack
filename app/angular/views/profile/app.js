...
define(['angularAMD'], function(app) {
    app.controller('profileCtrl', [
        'localStorageService', '$rootScope', '$scope', '$cookies', '$resource', '$modal', '$state', '$stateParams', '$timeout', '$filter',
        'user',
        function (localStorageService, $rootScope, $scope, $cookies, $resource, $modal, $state, $stateParams, $timeout, $filter, user) {
